...
const About = () => {
  ...
  const googleDriveLink = "https://drive.google.com/file/d/1nEL5BuxKKB64vwjuJTYZagEnNBtrgZK1/view?usp=sharing";
          ...
          <div className="p-2">
            <div className="text-gray-300 my-3">
              <p className="text-justify leading-7 w-11/12 mx-auto">
                I am currently pursuing B.tech in Computer Engineering from MITAOE,Pune, As a Developer specializing in web development and Machine Learning With hands-on experience in crafting dynamic user interfaces, I bring a blend of creativity and technical expertise to my role.
